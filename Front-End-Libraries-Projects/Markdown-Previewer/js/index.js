      ...
      return (
        React.createElement("div", { className: "row" },
          React.createElement("div", { className: "col-md-6 text-center" },
            ...
            React.createElement("textarea", { onChange: this.handleChange.bind(this), value: this.state.markdown })),
...
ReactDOM.render(React.createElement(App, null), document.querySelector('.myContent'));